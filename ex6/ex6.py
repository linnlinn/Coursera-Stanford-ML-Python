...
from ex6.visualizeBoundaryLinear import visualizeBoundaryLinear
...
data = scipy.io.loadmat('ex6/ex6data1.mat')
X = data['X']
y = data['y'].flatten()
...
# Load from ex6data2:
# You will have X, y in your environment
data = scipy.io.loadmat('ex6/ex6data2.mat')
X = data['X']
y = data['y'].flatten()
...
# Load from ex6data3:
# You will have X, y in your environment
data = scipy.io.loadmat('ex6/ex6data3.mat')
X = data['X']
y = data['y'].flatten()
